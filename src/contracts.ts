...
export const invoiceAbi = [
  "function createInvoice(address payer,uint256 amount,uint64 dueDate,bytes32 memoHash) returns (uint256)",
  "function cancelInvoice(uint256 invoiceId)",
  "function payInvoice(uint256 invoiceId)",
  "function getInvoice(uint256 invoiceId) view returns ((uint256 id,address issuer,address payer,uint256 amount,uint64 dueDate,bytes32 memoHash,uint64 createdAt,uint64 paidAt,bool canceled))",
  ...
  "event InvoiceCreated(uint256 indexed invoiceId,address indexed issuer,address indexed payer,uint256 amount,uint64 dueDate,bytes32 memoHash)",
